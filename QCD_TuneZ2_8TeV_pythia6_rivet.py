...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Summer2012 sample with PYTHIA6: QCD dijet production, pThat = %d .. %d GeV, TuneZ2'%(min_pt, max_pt)),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('QCD_Pt_%dto%d_TuneZ2_8TeV_pythia6_GEN_%03d.root'%(min_pt, max_pt, f_num)),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(29991400000.0),
...
process.rivetAnalyzer.OutputFile = cms.string('QCD_Pt_%dto%d_TuneZ2_8TeV_pythia6_rivet_%03d.yoda'%(min_pt, max_pt, f_num))
